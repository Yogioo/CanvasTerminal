...
pub struct GraphApp {
    ...
    script_bg_textures: HashMap<String, TextureHandle>,
    script_bg_texture_errors: HashMap<String, String>,
    ...
    text_context_menu_selection: Option<(usize, std::ops::Range<usize>)>,
    text_context_menu_screen_pos: Option<Pos2>,
